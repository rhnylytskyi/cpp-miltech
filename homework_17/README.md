...
Запуск симулятора навколишнього середовища. Симулятор підключається до порту `/tmp/ttyB`, керує віртуальними GPIO-лініями та прораховує балістику влучання боєприпасу з прискоренням часу в 10 разів.
```bash
...
### 💻 Термінал 4: Бортовий автопілот (Твій код)
...
## 📊 Результати роботи
Після успішного отримання мережевого підтвердження `COMMAND_ACK` та фіксації влучання, автопілот автоматично завершує всі потоки і створює файл звіту місії:
* **`data/simulation.json`** — повний трек траєкторії для веб-візуалізатора курсу.
