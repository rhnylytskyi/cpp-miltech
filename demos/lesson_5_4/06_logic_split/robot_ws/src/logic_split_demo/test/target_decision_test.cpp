...
{
  const auto decision = logic_split_demo::decide(
    logic_split_demo::TargetInput{false, 0.95F, 10.0F},
    kConfig);
...
{
  const auto decision = logic_split_demo::decide(
    logic_split_demo::TargetInput{true, 0.40F, 10.0F},
    kConfig);
...
{
  const auto decision = logic_split_demo::decide(
    logic_split_demo::TargetInput{true, 0.90F, 45.0F},
    kConfig);
